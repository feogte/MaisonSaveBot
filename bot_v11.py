...
async def handle_business_command(
    ...
    if message.from_user.id != owner["owner_user_id"]:
        return
...
async def on_business_message(message: Message):
    ...
    # Commands are written by the owner directly in the customer chat.
    if (
        owner
    ...
    # Only customer messages are archived/processed below.
    # Outgoing messages from the Business owner are ignored.
    if owner and message.from_user and message.from_user.id == owner["owner_user_id"]:
        return
