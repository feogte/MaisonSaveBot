...
async def on_business_message(message: Message):
    ...
    # Telegram can represent outgoing Business messages with the connected
    # user's sender or with sender_business_bot when the Business bot itself
    # sent the message. Accept both forms.
    is_owner_message = (
        (
...
async def main():
    ...
    log.info("MaisonSaveBot MULTI v15 started")
